...
vim.cmd [[au FileType ruby ++once lua require("packer.load")({'vim-bundler', 'vim-textobj-erb', 'vim-ruby-sinatra', 'vim-rails', 'vim-ruby', 'vim-rake', 'vim-slim', 'vim-ruby-run'}, { ft = "ruby" }, _G.packer_plugins)]]
vim.cmd [[au FileType erb ++once lua require("packer.load")({'vim-bundler', 'vim-textobj-erb', 'vim-textobj-erb', 'vim-ruby-sinatra', 'vim-rails', 'vim-ruby', 'vim-slim', 'vim-ruby-run'}, { ft = "erb" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType rb ++once lua require("packer.load")({'vim-bundler', 'vim-textobj-erb', 'vim-ruby-sinatra', 'vim-rails', 'vim-ruby', 'vim-rake', 'vim-slim', 'vim-ruby-run'}, { ft = "rb" }, _G.packer_plugins)]]
