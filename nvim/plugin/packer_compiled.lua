...
_G.packer_plugins = {
  ...
  ["nvim-web-devicons"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/baka/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
  ...
  ["vim-table-mode"] = {
    loaded = true,
    path = "/home/baka/.local/share/nvim/site/pack/packer/start/vim-table-mode",
...
vim.cmd [[au FileType erb ++once lua require("packer.load")({'vim-bundler', 'vim-textobj-erb', 'vim-textobj-erb', 'vim-slim', 'vim-ruby-sinatra', 'vim-ruby', 'vim-rails', 'vim-ruby-run'}, { ft = "erb" }, _G.packer_plugins)]]
vim.cmd [[au FileType rb ++once lua require("packer.load")({'vim-bundler', 'vim-textobj-erb', 'vim-slim', 'vim-ruby-sinatra', 'vim-ruby', 'vim-rails', 'vim-rake', 'vim-ruby-run'}, { ft = "rb" }, _G.packer_plugins)]]
vim.cmd [[au FileType ruby ++once lua require("packer.load")({'vim-bundler', 'vim-textobj-erb', 'vim-slim', 'vim-ruby-sinatra', 'vim-ruby', 'vim-rails', 'vim-rake', 'vim-ruby-run'}, { ft = "ruby" }, _G.packer_plugins)]]
