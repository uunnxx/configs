...
return require('packer').startup(function(use)
    ...
    use { 'tpope/vim-rails', ft = {'ruby', 'rb', 'erb'} }
    use { 'tpope/vim-rake', ft = {'ruby', 'rb', 'Rakefile', 'rake'} }
    use { 'tpope/vim-bundler', ft = {'ruby', 'rb', 'erb'} }
    use { 'slim-template/vim-slim', ft = {'ruby', 'rb', 'erb'} }
    use { 'stjernstrom/vim-ruby-run', ft = {'ruby', 'rb', 'erb'} }
    use { 'hallison/vim-ruby-sinatra', ft = {'ruby', 'rb', 'erb'} }
    ...
    use {
        'alvan/vim-closetag',
        ft = {'html', 'html5', 'htmldjango', 'xhtml', 'xml'}
    }
